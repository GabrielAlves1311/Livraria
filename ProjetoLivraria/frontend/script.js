...
formCep.addEventListener('submit', async (evento) => {
  ...
  try {
    ...
    logradouro.innerText = dados.logradouro || 'Não informado';
    bairro.innerText = dados.bairro || 'Não informado';
    cidade.innerText = dados.cidade || 'Não informado';
    estado.innerText = dados.estado || 'Não informado';
    ddd.innerText = dados.ddd || 'Não informado';
